...
const ChildUserDisplay = ({
  ...
  <div className="flex flex-col gap-4 w-full">
    ...
    <InfoRow
      ...
      value={[
        ...
        maskInfo(user.reporter_education),
      ]
        .filter(Boolean)
        .join('، ')}
      icon={<></>}
  ...
  <div className="flex flex-col gap-4 w-full">
    ...
    <InfoRow
      label={t('users.absence_report_number', 'Absence Report Number')}
      value={maskInfo(user.absence_report_number)}
      icon={<></>}
    />

    <InfoRow
      label={t('users.absence_report_date', 'Absence Report Date')}
      value={maskInfo(user.absence_report_date)}
      icon={<></>}
    />

    <InfoRow
      label={t('users.police_station', 'Police Station')}
      value={maskInfo(user.police_station)}
      icon={<></>}
    />

    <InfoRow
      label={t('users.security_directorate', 'Security Directorate')}
  ...
  <div className="flex flex-col gap-4 w-full">
    ...
    <InfoRow
      label={t('users.missing_person_education', 'Missing Person Education')}
...
>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
    ...
    <div className="flex flex-col gap-4 w-full">
      ...
      />
      <InfoRow
        label={t('users.clothes_description', 'Clothes Description')}
