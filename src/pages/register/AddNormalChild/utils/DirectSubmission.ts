...
export const submitChildForm = async (
  ...
  try {
    ...
    // DO NOT add the unique ID directly to FormData as the database schema doesn't have this column
    // Instead, keep track of it in memory and in the JSON payload
    ...
    const childData = {
      ...
      // Track unique_id only in client memory and localStorage, not in server payload
